...
c.url.default_page = '/home/asifakonjee/Downloads/Linux apps/Startpage/index.html'
c.url.start_pages = '/home/asifakonjee/Downloads/Linux apps/Startpage/index.html'
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://startpage.com/?q={}', 'aw': 'https://wiki.archlinux.org/?search={}', 'goog': 'https://www.google.com/search?q={}', 'ub': 'https://www.urbandictionary.com/define.php?term={}', 'wiki': 'https://en.wikipedia.org/wiki/{}', 'yt': 'https://www.youtube.com/results?search_query={}'}
...
c.fonts.web.family.sans_serif = '"Siyam Rupali"'
...
# Type: Font
c.fonts.completion.entry = '12pt "JetBrains Mono Nerd Font"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '12pt "JetBrains Mono Nerd Font"'

# Font used for prompts.
# Type: Font
c.fonts.prompts = 'default_size serif'

# Font used in the statusbar.
# Type: Font
c.fonts.statusbar = '12pt "JetBrains Mono Nerd Font"'

# Mouse Binding for Tab Bar
...
config.bind('<Ctrl+Up>', 'tab-next')
config.bind('<Ctrl+Down>', 'tab-prev')
